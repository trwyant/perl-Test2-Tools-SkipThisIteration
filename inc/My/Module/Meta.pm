...
sub abstract {
    return 'Test2 skip() variant that only skips the current iteration.';
}
...
sub dist_name {
    return 'Test2-Tools-SkipThisIteration';
}
...
sub meta_merge {
	...
	resources	=> {
	    bugtracker	=> {
#		web	=> 'https://rt.cpan.org/Public/Dist/Display.html?Name=Test2-Tools-SkipThisIteration',
#		# web	=> 'https://github.com/trwyant/perl-Test2-Tools-SkipThisIteration/issues',
		mailto  => 'wyant@cpan.org',
	    },
	    license	=> 'http://dev.perl.org/licenses/',
#	    repository	=> {
#		type	=> 'git',
#		url	=> 'git://github.com/trwyant/perl-Test2-Tools-SkipThisIteration.git',
#		web	=> 'https://github.com/trwyant/perl-Test2-Tools-SkipThisIteration',
#	    },
	},
	@extra,
    };
...
sub version_from {
    return 'lib/Test2/Tools/SkipThisIteration.pm';
}
...
My::Module::Meta - Information needed to build Test2::Tools::SkipThisIteration
...
This module centralizes information needed to build C<Test2::Tools::SkipThisIteration>. It
is private to the C<Test2::Tools::SkipThisIteration> package, and may be changed or
...
modules required to build the C<Test2::Tools::SkipThisIteration> package, suitable for
...
the modules required to run the C<Test2::Tools::SkipThisIteration>
